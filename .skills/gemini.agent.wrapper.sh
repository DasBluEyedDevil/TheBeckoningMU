...
${BLUE}OPTIONS:${NC}
    -d, --dir DIRS         Directories to include (e.g., "@commands/ @typeclasses/")
...
${BLUE}EXAMPLES:${NC}
    ${YELLOW}# Analyze command implementation${NC}
    $0 -d "@commands/ @typeclasses/" "How are V5 dice commands implemented? Show file paths and code."

    ${YELLOW}# Trace a bug${NC}
    $0 -d "@commands/ @world/" "Error at dice.py:145. Trace root cause through call stack."
    ...
    $0 -d "@commands/" "Changes: [summary]. Verify architectural consistency with Evennia patterns."
...
${BLUE}PROMPT BEST PRACTICES:${NC}
    ✅ Be specific: "How are Blood traits implemented?" vs "How does this work?"
    ✅ Request structure: "Provide: 1) file paths, 2) code excerpts, 3) recommendations"
    ✅ Include context: "Bug: 500 error at line 145. Trace Hunger dice flow."
